---
title: "Organizations"
description: "Relate lets you build all your communication history for each Organization you work with."
---
...
![Add Org](/docs/images/features/add-org.png)

You can add a new Organization by clicking `+Organization` button as shown in the screenshot above.



<Tip>When you're creating a new Organization, you can also create a Person. Click `Add contact data` located at the bottom of the modal.</Tip>
...
![Org detail](/docs/images/features/org-detail.png)
...
![Org detail timeline](/docs/images/features/org-detail-timeline.png)
...
<Warning> Currently, new emails sent directly from Relate does NOT appear in Relate real time. Rest assured, the email was sent, it just didn't appear right away. If you want to double check whether your email was sent, go to your original email service and check your Sent folder. </Warning>



<Tip> To start sending emails, you must [connect your email](/setup/email-integration/google-outlook-etc) first. </Tip>



### 2. Forward, Reply, or Reply All

![reply-email-button](/docs/images/features/reply-email-button.png)
...
![reply-email](/docs/images/features/reply-email.png)
...
![markdown](/docs/images/features/markdown.png)
...
![slack](/docs/images/features/slack-integration.png)
