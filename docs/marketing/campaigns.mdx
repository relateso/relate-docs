...
An active contact is a contact that you have sent a campaign to within a 30-day period.
For example, if you have 1,000 contacts registered in Relate and you've sent to 100 people through Relate Campaigns in the last 30 days, then you have 100 active contacts.

The reason Relate distinguishes between Contacts and Active Contacts is to ensure fair billing policies.
With other email services, if you have a lot of Contacts in your workspace, you'll always pay for them, regardless of how many people you actually communicate with.
