...
Please follow the procedure provided on each email service link page to complete. Then, follow the [Creating Connections for each Workspace](/setup/email-sync#creating-connections).
...
<Warning>
  **If you have already connected your email through Google and Outlook, skip
  this step and go to [Creating Connections for each Workspace](/setup/email-sync#creating-connections).**
</Warning>
