...
ACV represents annualized value. If the contract is written up every month, you can calculate ACV by multiplying a contract’s monthly recurring revenue (MRR) by 12. For example, for a customer with a monthly subscription worth $100, their ACV would be $1,200 ($100* 12 months).
