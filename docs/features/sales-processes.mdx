...
Each process can be managed separately as well as linked to each other. You can see how to connect them below in [Connecting Prospects and Pipeline](/features/sales-processes#connecting-prospects-and-pipeline).
...
You can see how to connect them below in [Connecting Prospects and Pipeline](/features/sales-processes#connecting-prospects-and-pipeline).
