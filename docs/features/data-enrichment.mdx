...
New records
- When adding a new [organization](https://www.relate.so/docs/features/organizations) or contact, input the company domain or company email address to automatically enrich details such as company descriptions or job titles.
