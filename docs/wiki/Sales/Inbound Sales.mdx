...
<Card title="Inbound Sales vs. Outbound Sales" icon={duotone("lightbulb")}>
  Find more information about [inbound vs. outbound sales](https://www.relate.so/blog/inbound-outbound-sales/) in our blog.
</Card>