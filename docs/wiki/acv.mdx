...
ACV represents annualized value. If the contract is written up every month, you can calculate ACV by multiplying a contract’s [Monthly Recurring Revenue (MRR)](/SaaS/MRR/) by 12. For example, for a customer with a monthly subscription worth $100, their ACV would be $1,200 ($100* 12 months).
...
ACV and [ARR (Annual Recurring Revenue)](/SaaS/ARR/) are both key performance indicators that cover revenue and are measured annually. That makes them pretty easy to mix up.
