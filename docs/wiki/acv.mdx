...
Average Contract Value (ACV) refers to the annualized revenue per customer contract. It represents the average annual dollar amount a contract is worth. ACV is an important financial metric for SaaS companies and companies that predominantly deal with yearly subscriptions and contracts. 
...
ACV represents annualized value. If the contract is written up every month, you can calculate ACV by multiplying a contract’s [Monthly Recurring Revenue (MRR)](/docs/wiki/SaaS/MRR/) by 12. For example, for a customer with a monthly subscription worth $100, their ACV would be $1,200 ($100* 12 months).
...
ACV and [ARR (Annual Recurring Revenue)](/docs/wiki/SaaS/ARR/) are both key performance indicators that cover revenue and are measured annually. That makes them pretty easy to mix up.
