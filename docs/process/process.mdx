...
Each [Entry](/process/process#1-entry) represents a sales opportunity for the associated Organization/Contact.
...
Here are the process templates currently available in Relate (click on the template name to go to the guide).
- [Default process](/process/default)
- [Sales process](/process/sales)
- [Simple sales process](/process/simple-sales)
- [Other process](/process/other): Fundraising, Recruiting
